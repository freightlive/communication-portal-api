...
class PortalParameterModel implements ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        if (!in_array($this->container['type'], $allowed_values)) {
            $invalid_properties[] = "invalid value for 'type', must be one of 'boolean', 'integer', 'string'.";
        }
    ...
    {
        $allowed_values = array('boolean', 'integer', 'string');
        if (!is_null($type) && (!in_array($type, $allowed_values))) {
            throw new \InvalidArgumentException("Invalid value for 'type', must be one of 'boolean', 'integer', 'string'");
        }
